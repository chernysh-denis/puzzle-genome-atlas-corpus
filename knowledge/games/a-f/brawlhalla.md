...
- [Confirmed | Direct | High] Current Offline Play settings isolate ordinary
  Stock from variations, gadgets, ranked and account progression (`BHL-002`,
  `BHL-003`, `BHL-009`).
- [Observation | Corroborated | High] Accumulated damage changes launch risk,
  while blast-zone exits consume a recoverable stock and final stock settles
  the match (`BHL-005`, `BHL-008`).

## Нові гени

- [Observation | Corroborated | High] Twelve genes isolate arena-weapon
  interaction, dodge commitment, damage-to-launch conversion, stock reset,
  compatible pickup assignment, aerial recovery state, blast zones, paired
  stock HUD and last-stock victory.

## Нові комбінації

- [Observation | Corroborated | High] `COMB-0196` records the strict defining
  subset that couples fixed fighters, spatial weapons, damage-driven launch,
  resettable recovery and a three-stock blast-zone terminal.

## Зміни таксономії

- [Observation | Direct | High] Змін таксономії немає; new boundaries and
  evidence support do not alter any previously reviewed signature.

## Нові питання

- Which later platform fighter reuses stock, blast-zone and aerial-recovery
  boundaries while falsifying Brawlhalla's spawned two-weapon assignment?

## Наступна рекомендована гра

- [Confirmed | Corroborated | High] `SEARCH_DEMAND_BATCH_007_AUDIT`.
- Optimisation criterion: independently verify the complete nine-game Selection
  007 batch after its final one-game commit.
- Expected information gain: test IDs, bounded scopes, source quality,
  translations, artwork, derived artifacts, comparison parity and final totals
  across `GAME-0190`–`GAME-0198`.
- Backlog impact: closes the active nine-game Goal without selecting or
  beginning another horizon.

## Чому саме вона

- [Confirmed | Corroborated | High] The ninth selected game completes one full
  catalogue page, so an independent batch audit is now higher value than
  silently expanding the corpus further.
