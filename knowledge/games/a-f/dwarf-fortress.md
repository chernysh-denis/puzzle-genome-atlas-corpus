...
- Prior game signatures scanned: `125` (`GAME-0001`–`GAME-0125`).
- Exact genome matches: none.
- Tied near matches: `GAME-0125` — Oxygen Not Included (`21 / 64 = 0.328125`).
- Supported combination subsets: `COMB-0124`.
- Scan date: 2026-08-18.

### Selected-neighbour interpretation

No pre-migration reviewed selected-neighbour table row exists for: `GAME-0125`.
