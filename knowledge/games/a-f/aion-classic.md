...
- Поточний North American Aion Classic працює на Patch 5.0 через PURPLE, а
  `Boundary of Light and Darkness` має точний одноразовий навчальний маршрут.
- Офіційний гайд визначає три лічильники ворогів, три Mystic Cube, посилені
  нагороди та незворотний вихід через Daeva of Time.

## Нові гени

- `ACT-391`, `SYS-720`, `SYS-721`, `CON-563` і `OBJ-139` відокремлюють удар по
  кубу, випадкове повне скидання відновлення вмінь, розвиток куба й нагороди,
  одноразовий допуск і точний термінал.

## Нові комбінації

- `COMB-0221` — від керованого навчального бою через випадкові скидання
  відновлення та посилення кубів до незворотного збереженого виходу.

## Зміни таксономії

- Додано п'ять Active-меж без зміни наявних генів або сигнатур.

## Нові питання

- Чи дасть Once Human іншу структуру входу, якщо його навчання залежить від
  сценарію й фази, а не від одноразового персонального інстансу?

## Наступна рекомендована гра

- [Confirmed | Direct | High] `GAME-0224` Once Human.
- Optimisation criterion: compare a current persistent survival scenario with
  this one-use authored tutorial while preserving Batch 010 order.
- Expected information gain: scenario phases, territory crafting and anomalous
  companion boundaries.
- Backlog impact: Unit 8 of the active nine-game Goal.

## Чому саме вона

- It is the next authorised subject in `SEARCH_DEMAND_GAME_SELECTION_010` and
  contrasts a rotating persistent scenario with a closed Classic tutorial.
