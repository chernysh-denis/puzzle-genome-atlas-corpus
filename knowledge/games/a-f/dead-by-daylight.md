...
- [Confirmed | Corroborated | High] Dead by Daylight 10.1.0 joins a five-of-
  seven repair quota to asymmetric tracking, consumable chase geometry,
  teammate Hook rescue and a gate/Hatch escape deadline (`DBD-001`–`DBD-008`).

## Нові гени

- [Observation | Corroborated | High] Added twenty-one bounded genes for the
  Survivor interaction, Trial setup, repair, timing, health, tracks, chase,
  Hook, escape, role, quota, state, information and objective boundaries.

## Нові комбінації

- [Observation | Corroborated | High] `COMB-0159` isolates repair under
  asymmetric pursuit into staged rescue and a terminal escape window.

## Зміни таксономії

- [Observation | Corroborated | High] No taxonomy migration; four existing
  families and seven established generic genes are reused unchanged.

## Нові питання

- Will another asymmetric pursuit game recur the strict repair–Hook–gate
  subset without Dead by Daylight's exact health and tracking channels?

## Наступна рекомендована гра

- [Hypothesis | Limited | High] `GAME-0162` Path of Exile 2.
- Optimisation criterion: complete the authorised demand-led Goal in order.
- Expected information gain: contrast one survivor-scale asymmetric match with
  an early persistent action-RPG campaign and its skill-gem/equipment economy.
- Backlog impact: advances the authorised nine-game batch to its final unit.

## Чому саме вона

- [Hypothesis | Limited | High] It is the ninth and final recorded game in the
  current authorised horizon.
