...
- [Confirmed | Corroborated | High] FC 26 v1.6.6 combines one-ball physics,
  transferable direct control, eleven-player team AI and football adjudication
  inside a bounded two-half Classic Match (`FC26-001`–`FC26-009`).

## Нові гени

- [Observation | Corroborated | High] Added sixteen genes for ball actions,
  ball/contact/AI/referee/keeper/goal/clock resolution, football constraints,
  broadcast information and the relative regulation objective.

## Нові комбінації

- [Observation | Corroborated | High] `COMB-0161` isolates directly switched
  eleven-player football coordination into a regulation score result.

## Зміни таксономії

- [Observation | Corroborated | High] No taxonomy migration; four established
  generic genes and four existing multi-game families are reused unchanged.

## Нові питання

- Which later sports simulation first reuses the transferable-control plus
  role-AI substrate while replacing football's offside and restart laws?

## Наступна рекомендована гра

- [Hypothesis | Limited | High] `GAME-0164` — The Binding of Isaac: Rebirth.
- Optimisation criterion: continue the recorded demand-led horizon in exact order.
- Expected information gain: compare room reset, item synergies, tears, health
  economy and procedural run structure against the current corpus.
- Backlog impact: second of nine authorised game units.

## Чому саме вона

- [Hypothesis | Limited | High] It is the next immutable subject in
  `SEARCH_DEMAND_GAME_SELECTION_004` and should add a sharply different
  procedural action-roguelike signature after the sports-simulation unit.

## Localisation status

- Ukrainian game, new-gene and combination entries are reviewed in this unit.
- The canonical brand title remains `EA SPORTS FC 26`; no invented translated
  brand is appended.

## Open questions

- Re-check the title-update boundary before any future review-on-touch.
- A later direct-play module could measure switching and default-assistance edge
  cases without changing the present causal types.

## Source notes

- Official pages and the latest official update index were checked on
  2026-08-27. The linked v1.6.6 forum page was the newest gameplay title update
  found; later service or Ultimate Team posts do not alter this offline scope.
- IFAB laws define the represented football predicates; the claim is that FC 26
  implements those match rules approximately, not that its physics are law text.

## Next recommended action

- Integrate `GAME-0164` — The Binding of Isaac: Rebirth after the required
