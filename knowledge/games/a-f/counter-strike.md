...
- Зафіксовано поточний клієнт Steam app `10`, версію `1.6`, збірку
  `12934623`, офіційний серверний пакет, штатний `de_dust2` і незмінений
  20-хвилинний `server.cfg` як одну відтворювану одиницю.
- Підтверджено, що боти для оригінального Counter-Strike потребують стороннього
  доповнення й тому не входять до аналізу.

## Нові гени

- `OBJ-135` — дійти до штатного завершення часу мапи та зберегти командний
  рахунок раундів як перемогу однієї сторони або нічию.

## Нові комбінації

- `COMB-0216` — закупівлі, передавання спорядження, один шанс на раунд,
  асиметрична C4, економіка між раундами та фінальний рахунок на штатному
  20-хвилинному циклі мапи.

## Зміни таксономії

- Додано один вузький Objective gene; наявні 27 механічних меж і всі раніше
  перевірені сигнатури залишено без змін.

## Нові питання

- Чи дасть окремий stock hostage-map packet нову цільову межу без змішування
  його з цією Bomb/Defuse сесією?

## Наступна рекомендована гра

- [Confirmed | Direct | High] `GAME-0219` Lineage II.
- Optimisation criterion: compare one current official MMORPG quest packet
  against the existing persistent-world, party and combat corridor.
- Expected information gain: isolate a bounded current-service character loop
  without importing the full class tree, economy or product history.
- Backlog impact: continue Batch 010 while retaining the scheduled spacing
  between Lineage II, World of Warcraft and Aion Classic.

## Чому саме вона

- [Hypothesis | Limited | Medium] Lineage II should strongly exercise reusable
  persistent-world movement and combat genes while forcing an explicit quest
  entry, client branch and terminal that differ from the tactical shooter unit.
