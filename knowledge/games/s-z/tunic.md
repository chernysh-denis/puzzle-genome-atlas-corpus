...
- Genome signature `(ACT; SYS; CON; INF; OBJ; TIM)`:
  `(ACT-008,ACT-106; SYS-037,SYS-139; CON-158; INF-001,INF-054; OBJ-026; TIM-015)`.
- Indexed games scanned: 104, including this record.
- Indexed combinations scanned: 104.
- Exact genome matches: none.
- Near matches and similarity scores: `GAME-0098` is nearest at
  `3 / 13 = 0.230769`; it shares navigation, visible state and reaching a
  designated location but not manual-mediated symbolic input.
- Supported combination subsets: `COMB-0104` only.
...
- `GAME-0005`: `1 / 15 = 0.066667`; `GAME-0006`: `2 / 16 = 0.125000`; `GAME-0007`: `1 / 16 = 0.062500`; `GAME-0008`: `1 / 15 = 0.066667`.
...
- `GAME-0021`: `2 / 16 = 0.125000`; `GAME-0022`: `1 / 20 = 0.050000`; `GAME-0023`: `0 / 19 = 0.000000`; `GAME-0024`: `0 / 21 = 0.000000`.
- `GAME-0025`: `1 / 19 = 0.052632`; `GAME-0026`: `1 / 20 = 0.050000`; `GAME-0027`: `1 / 20 = 0.050000`; `GAME-0028`: `1 / 25 = 0.040000`.
- `GAME-0029`: `2 / 19 = 0.105263`; `GAME-0030`: `1 / 22 = 0.045455`; `GAME-0031`: `1 / 19 = 0.052632`; `GAME-0032`: `1 / 19 = 0.052632`.
- `GAME-0033`: `2 / 20 = 0.100000`; `GAME-0034`: `3 / 20 = 0.150000`; `GAME-0035`: `2 / 25 = 0.080000`; `GAME-0036`: `2 / 19 = 0.105263`.
- `GAME-0037`: `1 / 17 = 0.058824`; `GAME-0038`: `3 / 22 = 0.136364`; `GAME-0039`: `1 / 17 = 0.058824`; `GAME-0040`: `3 / 14 = 0.214286`.
- `GAME-0041`: `2 / 18 = 0.111111`; `GAME-0042`: `1 / 17 = 0.058824`; `GAME-0043`: `2 / 21 = 0.095238`; `GAME-0044`: `2 / 17 = 0.117647`.
- `GAME-0045`: `3 / 20 = 0.150000`; `GAME-0046`: `1 / 18 = 0.055556`; `GAME-0047`: `1 / 22 = 0.045455`; `GAME-0048`: `1 / 22 = 0.045455`.
- `GAME-0049`: `0 / 18 = 0.000000`; `GAME-0050`: `2 / 22 = 0.090909`; `GAME-0051`: `1 / 24 = 0.041667`; `GAME-0052`: `1 / 18 = 0.055556`.
- `GAME-0053`: `2 / 16 = 0.125000`; `GAME-0054`: `3 / 17 = 0.176471`; `GAME-0055`: `2 / 17 = 0.117647`; `GAME-0056`: `1 / 16 = 0.062500`.
...
- `GAME-0069`: `1 / 16 = 0.062500`; `GAME-0070`: `2 / 15 = 0.133333`; `GAME-0071`: `1 / 15 = 0.066667`; `GAME-0072`: `1 / 16 = 0.062500`.
...
- `GAME-0089`: `1 / 17 = 0.058824`; `GAME-0090`: `3 / 21 = 0.142857`; `GAME-0091`: `3 / 15 = 0.200000`; `GAME-0092`: `2 / 17 = 0.117647`.
- `GAME-0093`: `2 / 16 = 0.125000`; `GAME-0094`: `2 / 17 = 0.117647`; `GAME-0095`: `2 / 19 = 0.105263`; `GAME-0096`: `2 / 17 = 0.117647`.
- `GAME-0097`: `3 / 14 = 0.214286`; `GAME-0098`: `3 / 13 = 0.230769`; `GAME-0099`: `2 / 15 = 0.133333`; `GAME-0100`: `0 / 20 = 0.000000`.
- `GAME-0101`: `1 / 18 = 0.055556`; `GAME-0102`: `0 / 16 = 0.000000`; `GAME-0103`: `1 / 17 = 0.058824`.
...
- [Confirmed | Corroborated | High] Візерунчасті двері перевіряють точну
  напрямну послідовність, а не володіння сторінкою 43: знання коду саме по собі
  відкриває шлях до сторінок 44–45 (`TUN-004`, `TUN-005`).

## Нові гени

- [Observation | Corroborated | High] `ACT-106` — ввести напрямний код без
  переміщення; `SYS-139` — розпізнати буфер і відкрити адресовану печать.
- [Observation | Corroborated | High] `CON-158` — точна впорядкована
  кардинальна траєкторія одного замка; `INF-054` — поступово зібрана стала
  дієгетична інструкція.
- [Observation | Corroborated | High] `TIM-015` — безштрафне скидання
  незавершеного коду після надмірної паузи.

## Нові комбінації

- [Confirmed | Corroborated | High] `COMB-0104` — прочитати зібрану підказку,
  ввести точний часово зв’язний напрямний код і відкрити знанням світовий шлях.

## Зміни таксономії

- Не потрібні: п’ять нових меж додаються без зміни чинних визначень; чотири
