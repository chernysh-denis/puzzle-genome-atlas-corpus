...
- [Confirmed | Corroborated | High] Current Patch 8.1.1 / public build
  24237342 supports a bounded The Lost God route from first campaign control
  through Kislev Refuge and one manual Beacon battle to returned Rescue state
  (`TWW3-001`–`TWW3-012`).

## Нові гени

- [Observation | Corroborated | High] Added twelve genes for slot-bound
  campaign construction, movement allowance, deployment legality, morale
  routing, strategic/battle information, cross-layer result transfer and the
  first Beacon rescue terminal.

## Нові комбінації

- [Observation | Corroborated | High] `COMB-0189` isolates the joined
  campaign-turn, settlement, deployment, formation battle, morale and returned
...
- Which lower-scope strategy tutorial also returns casualties from a separately
  deployed live battle into a turn-settled settlement campaign?

## Наступна рекомендована гра

- [Confirmed | Direct | High] `GAME-0192` Left 4 Dead 2.
- Optimisation criterion: preserve the authorised demand order while replacing
  campaign/battle alternation with one bounded cooperative director-driven run.
- Expected information gain: shared health and rescue pressure, adaptive
  encounter pacing, incapacity and one authored safe-room terminal.
...
- Ukrainian game, twelve new-gene and combination entries are reviewed in this
  unit. The official trademark title remains unchanged; Ukrainian prose is
  presentation-only.

## Open questions

- Recheck the official patch/build and The Lost God availability on
  review-on-touch. Do not infer later prologue, campaign, faction, DLC,
  multiplayer or autoresolve systems without a separately bounded packet.
