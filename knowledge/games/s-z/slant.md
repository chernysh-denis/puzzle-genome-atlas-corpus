...
- Genome signature `(ACT; SYS; CON; INF; OBJ; TIM)`:
  `ACT-007; none; CON-001,CON-114,CON-115; INF-001; OBJ-006; TIM-002`.
- Indexed games scanned: `GAME-0001`–`GAME-0070`.
- Indexed combinations scanned: `COMB-0001`–`COMB-0070`.
- Exact genome matches: none.
- Tied nearest games: `GAME-0005` Sudoku and `GAME-0008` Nonogram, each at
  `5 / 9 = 0.555556`, sharing assignment, fixed capacity, full visibility,
  complete constraint satisfaction and self-paced time.
- Near match: Sudoku and Nonogram are the complete maximum-score set.
  Hexologic follows at `5 / 10 = 0.500000`.
- Supported combination subsets: none before `COMB-0071`; the two new graph
  predicates do not occur in any earlier combination.
- Scan date: 2026-08-14.

| Neighbour | Shared genes | Decision-relevant differences | Match result |
|---|---|---|---|
| `GAME-0005` — Sudoku | `ACT-007`, `CON-001`, `INF-001`, `OBJ-006`, `TIM-002` | Sudoku covers overlapping units with one complete all-different domain; Slant imposes exact vertex degrees plus graph-wide acyclicity | tied near match, `5 / 9 = 0.555556` |
| `GAME-0008` — Nonogram | `ACT-007`, `CON-001`, `INF-001`, `OBJ-006`, `TIM-002` | Nonogram satisfies ordered run descriptions on rows and columns; Slant treats assigned diagonals as edges and forbids cycles | tied near match, `5 / 9 = 0.555556` |
...
- Full numeric scan (`intersection / union = Jaccard`):
  ...
  - `GAME-0005`: `5 / 9 = 0.555556`; `GAME-0006`: `3 / 13 = 0.230769`; `GAME-0007`: `2 / 13 = 0.153846`; `GAME-0008`: `5 / 9 = 0.555556`.
  ...
  - `GAME-0061`: `4 / 13 = 0.307692`; `GAME-0062`: `5 / 10 = 0.500000`; `GAME-0063`: `3 / 11 = 0.272727`; `GAME-0064`: `2 / 10 = 0.200000`.
  - `GAME-0065`: `1 / 13 = 0.076923`; `GAME-0066`: `2 / 15 = 0.133333`; `GAME-0067`: `0 / 15 = 0.000000`; `GAME-0068`: `1 / 14 = 0.071429`.
  - `GAME-0069`: `3 / 12 = 0.250000`; `GAME-0070`: `2 / 13 = 0.153846`.
