...
- [Confirmed | Direct | High] Current base-game New In Town turns one supplied
  household member's open simulation into a visible, finite and
  branch-rewarded social scenario (`TS4-001`–`TS4-008`).

## Нові гени

- [Observation | Corroborated | High] `ACT-257`, `SYS-431`, `SYS-432`,
  `SYS-433`, `CON-380`, `INF-168`.

## Нові комбінації

- [Observation | Corroborated | High] `COMB-0156`.
...
- Does a career-focused base-game scenario require a separable work loop, or
  does it mostly reuse the same directed-resident and staged-goal signature?

## Наступна рекомендована гра

- [Hypothesis | Limited | High] Helldivers 2.
- Optimisation criterion: move from one directed resident and recoverable
  social planning to four-player cooperative combat with shared war effects.
- Expected information gain: test reinforcement, friendly fire, stratagem
  input and mission extraction against existing squad-combat records.
- Backlog impact: continue the authorised demand-led Goal.

## Чому саме вона

- [Hypothesis | Limited | High] It is the next recorded `GAME-0159` unit and
  provides maximal decision-loop contrast after a bounded life-sim scenario.
