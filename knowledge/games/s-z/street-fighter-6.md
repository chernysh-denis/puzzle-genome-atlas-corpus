...
- [Confirmed | Direct | High] Fighting Ground One on One isolates a complete
  traditional duel from World Tour, Battle Hub and online progression
  (`SF6-002`, `SF6-010`).
- [Confirmed | Direct | High] One six-stock Drive reserve supports five
  offensive/defensive techniques and changes the combat state through Burnout
  when exhausted (`SF6-006`, `SF6-007`).

## Нові гени

- [Observation | Corroborated | High] Sixteen genes isolate fighter setup,
  command attacks, guard/throw/Drive decisions, duel spacing, two coupled
  combat meters and finite round/match settlement.

## Нові комбінації

- [Observation | Corroborated | High] `COMB-0170` captures a side-view duel in
  which paired visible resources and real-time contact feed first-to-two round
  settlement.

## Зміни таксономії

- [Observation | Direct | High] Змін таксономії немає; додано лише нові
  boundaries and support links without revising prior signatures.

## Нові питання

- Which later fighting game will reuse the round, spacing and resource
  boundaries while falsifying Street Fighter 6-specific Drive coupling?

## Наступна рекомендована гра

- [Confirmed | Corroborated | High] `GAME-0173` Blue Prince.
- Optimisation criterion: alternate the real-time adversarial duel with the
  next recorded compact puzzle/exploration subject in Selection 005.
- Expected information gain: test drafted room topology, daily step pressure,
  retained clues and a meaningful Room 46 milestone against the newly added
  fixed-arena combat packet.
- Backlog impact: preserves the authorised `GAME-0172`–`GAME-0180` order.
