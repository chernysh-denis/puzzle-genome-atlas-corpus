...
- Поточний bounded packet — перша місія повстанців `Form the Vanguard` у
  фіксованому X-wing, а не вся кампанія чи мережевий режим.
- Точний термінал — завершити обов'язкову фінальну формацію, дійти до дебрифінгу
  й зберегти гарантовану медаль `Mission Complete`; додаткові медалі виключено.

## Нові гени

- `ACT-392`–`ACT-396`, `SYS-723`–`SYS-728`, `CON-565`, `INF-277` та `OBJ-141`
  ізолюють прямий політ, живий розподіл енергії, двобічні щити, протиракетну
  відповідь, підтримку AI-напарника й точне завершення місії.

## Нові комбінації

- `COMB-0223` — фіксована місія з кабіни поєднує прямий політ, спільну енергію,
  напрямлені щити, керовані ракети/контрзаходи та збережене завершення.

## Зміни таксономії

- Додано чотирнадцять Active-меж без зміни раніше reviewed сигнатур. Campaign,
  multiplayer, VR, HOTAS, інші кораблі, builds, ranks і service history лишилися
  поза пакетом.

## Нові питання

- Який окремий Fleet Battles packet найкраще ізолює командну економіку кораблів
  і capital-ship assault без змішування всіх карт та ролей?
- Чи потребує майбутній vehicle corridor узагальнення живого розподілу енергії,
  якщо друга гра також має щонайменше три конкуруючі підсистеми?

## Наступна рекомендована гра

- [Confirmed | Direct | High] `SEARCH_DEMAND_BATCH_010_AUDIT`.
- Optimisation criterion: independently verify all nine Batch 010 units, final
  counts, localisation, art, indexes, comparisons and generated artifacts.
- Expected information gain: detect unit-boundary drift or parity defects before
  any separately authorised publication.
- Backlog impact: final audit unit of the active nine-game Goal.

## Чому саме вона

- Це наступний і останній зафіксований unit Batch 010 після дев'яти game commits.

## Family classification

- `FAM-007` — Embodied spatial reasoning.
