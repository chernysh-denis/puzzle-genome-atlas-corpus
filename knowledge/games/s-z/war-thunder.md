...
- [Confirmed | Direct | High] Current War Thunder Ground Arcade combines up to
  three selected ground-vehicle lives, assisted armour targeting, internal
  crew/module damage, three-point majority and tickets (`WT-001`–`WT-010`).

## Нові гени

- [Observation | Corroborated | High] Added ten genes for lineup spawn choice,
  armour-path damage, Arcade impairment, heterogeneous respawn, proportional
  Domination tickets, shot legality, vehicle information and the team terminal.

## Нові комбінації

- [Observation | Corroborated | High] `COMB-0182` isolates the armour-shot to
  internal-damage to point/ticket loop across a bounded vehicle lineup.

## Зміни таксономії

- [Observation | Corroborated | High] No taxonomy migration; nine established
  generic genes and four existing multi-game families are reused unchanged.

## Нові питання

- Which later vehicle-combat game first reuses spatial internal damage while
  replacing three-point ticket pressure or the heterogeneous spawn budget?

## Наступна рекомендована гра

- [Confirmed | Direct | High] `GAME-0185` — Magic: The Gathering Arena.
- Optimisation criterion: continue the recorded demand-led Goal in exact order.
- Expected information gain: contrast simultaneous spatial armour combat with
  a bounded digital card rules engine, priority, stack and best-of-one terminal.
...
- The canonical brand title remains `War Thunder`; the presentation adds the
  established Ukrainian explanatory title where useful.

## Open questions

- Re-check the live patch, Arcade spawn rules and any damage-model revision
  before a later review-on-touch.
