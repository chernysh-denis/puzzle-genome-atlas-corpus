...
- [Confirmed | Direct | High] Product/edition/patch/add-on and manual-save
  boundaries are fixed by `KCD2-001`, `002`, `010`, `011`.
- [Observation | Corroborated | High] Entry, burial/herbs/dialogue, manual brew
  and successor are fixed by `KCD2-003`–`009`.

## Нові гени

- [Observation | Corroborated | High] `ACT-410`, `SYS-756`, `CON-581`,
  `INF-288`, `OBJ-148` isolate manual recipe execution and bounded closure.

## Нові комбінації

- [Observation | Corroborated | High] `COMB-0238` joins body triage, a deed,
  dialogue, gathered inputs, timed apparatus process and retained successor.
...
- Which other RPG requires a directly operated physical recipe apparatus to
  close one bounded quest?
- Which later game lets recipe grade, not mere item existence, gate successor?

## Наступна рекомендована гра

- [Hypothesis | Limited | Medium] `GAME-0241` — NBA 2K26.
- Contrast authored-world crafting with a bounded sports match settlement.

## Research artefacts

- `research/taxonomy-health/BASELINE_240.json`.
- `research/normalisation/GENE_DUPLICATE_QUEUE_090.md` and `.json`.
- `research/normalisation/GENE_LEXICAL_TOP_N_EXPERIMENT_090.md` and `.json`.

## Evidence gaps

- Build ID is secondary; official Patch 1.5.6 is primary version authority.
- No direct play; exact health/reputation/skill values and duration are
  parameters. Four bandages are supported by two routes while another
  summarises one treatment step, so count remains a parameter.
- No audiovisual evidence was used.

## Confidence

High for product/version/save bounds; medium-high for the reconstructed route.
