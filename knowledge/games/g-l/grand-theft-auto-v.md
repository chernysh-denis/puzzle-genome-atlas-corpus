...
- [Confirmed | Corroborated | High] Legal switching transfers control among
  three separately retained protagonists inside one advancing world (`GTA-004`).
- [Confirmed | Corroborated | High] Heist approach, role skill and cut change
  preparation, mistakes, retained take and later crew capability (`GTA-007`).

## Нові гени

- [Observation | Corroborated | High] 22 bounded genes cover contextual cover,
  GPS, protagonist switching and specials, wanted search, ambient population,
  mission retry, heist planning and terminal roster resolution.

## Нові комбінації

- [Confirmed | Corroborated | High] `COMB-0143` — concurrent protagonists and
  wanted-world action into planned heist completion.

## Зміни таксономії

- [Observation | Corroborated | High] Eleven reused records gain independent
  campaign evidence; four parameter wordings broaden without type or causal
  boundary change.

## Нові питання

- Does a later audit need a separate gene for optional free-roam hospital and
  police-station recovery when it is compared outside active mission attempts?

## Наступна рекомендована гра

- [Hypothesis | Limited | High] `GAME-0146` — Cyberpunk 2077.
- Optimisation criterion: continue the recorded demand-led tranche while
  comparing another authored open-world action RPG against GTA V's heist trio.
- Expected information gain: dialogue and quest branches, cyberware build
  capacity, hacking, stealth and a single persistent protagonist.
- Backlog impact: advances the second nine-game tranche without skipping.

## Чому саме вона

- [Hypothesis | Limited | High] Shared traversal, combat, vehicles and mission
  gates should create a useful bridge, while hacking, cyberware and quest-state
  branching should expose a sharply different decision structure.
