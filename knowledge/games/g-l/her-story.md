...
- Genome signature `(ACT; SYS; CON; INF; OBJ; TIM)`:
  `(ACT-108,ACT-109; SYS-142; CON-160; INF-012; OBJ-051; TIM-002)`.
- Indexed games scanned: 106, including this record.
- Indexed combinations scanned: 106.
- Exact genome matches: none.
- Near matches and similarity scores: `GAME-0023` is nearest at
  `2 / 15 = 0.133333`; it shares revisitable fixed evidence and self-paced
  interaction, but not typed retrieval, chronological capping or open-ended
  evidence-coverage progress.
- Supported combination subsets: `COMB-0106` only.
...
- `GAME-0009`: `0 / 23 = 0.000000`; `GAME-0010`: `0 / 16 = 0.000000`; `GAME-0011`: `1 / 19 = 0.052632`; `GAME-0012`: `1 / 15 = 0.066667`.
...
- `GAME-0021`: `0 / 16 = 0.000000`; `GAME-0022`: `0 / 19 = 0.000000`; `GAME-0023`: `2 / 15 = 0.133333`; `GAME-0024`: `1 / 18 = 0.055556`.
...
- `GAME-0037`: `0 / 16 = 0.000000`; `GAME-0038`: `0 / 23 = 0.000000`; `GAME-0039`: `1 / 15 = 0.066667`; `GAME-0040`: `1 / 14 = 0.071429`.
...
- `GAME-0069`: `1 / 14 = 0.071429`; `GAME-0070`: `0 / 15 = 0.000000`; `GAME-0071`: `1 / 13 = 0.076923`; `GAME-0072`: `1 / 14 = 0.071429`.
...
- `GAME-0101`: `1 / 16 = 0.062500`; `GAME-0102`: `1 / 13 = 0.076923`; `GAME-0103`: `0 / 16 = 0.000000`; `GAME-0104`: `0 / 16 = 0.000000`.
- `GAME-0105`: `0 / 17 = 0.000000`.
