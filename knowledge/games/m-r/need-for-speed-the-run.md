...
- [Confirmed | Direct | High] Офіційний PC manual визначає керування, HUD і
  скінченні checkpoint resets, а останнє таке відновлення програє подію
  (`NFSTR-004`–`NFSTR-007`).
- [Observation | Corroborated | High] Три події Stage 1 переводять місце з
  211-го на збережене 195-те й відкривають Stage 2 (`NFSTR-008`–`NFSTR-010`).

## Нові гени

- [Observation | Corroborated | High] `SYS-746`, `CON-577`, `INF-286` та
  `OBJ-146` ізолюють витратне відновлення, його межу, видимий стан і terminal
  накопичуваного рангу етапу.

## Нові комбінації

- [Observation | Corroborated | High] `COMB-0233` поєднує живе керування,
  скінченне повернення до checkpoint і багатоподійний ранговий terminal.

## Зміни таксономії

- [Confirmed | Direct | High] Жодну сигнатуру раніше перевіреної гри не
  змінено; конкретні машина, маршрути, числа й назви лишено параметрами.

## Нові питання

- Чи можна окремим законним патч-пакетом підтвердити primary provenance
  офіційного PC `1.1`, не підміняючи retail executable стороннім файлом?

## Наступна рекомендована гра

- [Confirmed | Corroborated | High] `GAME-0236` — Far Cry 3.
- Optimisation criterion: одна немодифікована early-story PC mission packet із
  збереженим successor checkpoint.
- Expected information gain: stealth-marking, outpost pressure and authored
  combat progression outside a whole island sandbox.
- Backlog impact: advances Batch 012 without reserve amendment.
