...
- [Confirmed | Corroborated | High] Pokémon Legends: Z-A 2.0.2 combines direct
  world capture with one explicitly commanded real-time party partner and a
  nighttime ticketed promotion loop (`PLZA-002`–`PLZA-008`).

## Нові гени

- [Observation | Corroborated | High] Added twelve bounded starter, switching,
  day/night competition, ticket, promotion, eligibility, disclosure and Rank Y
  objective genes.

## Нові комбінації

- [Observation | Corroborated | High] `COMB-0158` isolates capture-to-party
  preparation converted into awareness-sensitive real-time combat and a
  ticketed first promotion.

## Зміни таксономії

- [Observation | Corroborated | High] No taxonomy migration; four existing
  family boundaries are reused and compatible generic roster wording is
  clarified in place.

## Нові питання

- Does a later reviewed creature battler recur the strict live-partner switch
  and ticketed promotion subset without Z-A's day/night zone alternation?

## Наступна рекомендована гра

- [Hypothesis | Limited | High] `GAME-0161` Dead by Daylight.
- Optimisation criterion: continue the authorised demand-led Goal in order.
- Expected information gain: test one current public 1v4 trial's asymmetric
  role information, pursuit, repair, hook/rescue and escape/sacrifice outcomes.
- Backlog impact: advances the authorised nine-game batch to its eighth unit.

## Чому саме вона

- [Hypothesis | Limited | High] It is the next recorded unit and should replace
  one-trainer party coordination with a role-asymmetric five-player trial.
